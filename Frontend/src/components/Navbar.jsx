        ...
        <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky
            ...
            <div className="navbar">
                <div className="navbar-start">
                    ...
                    <a className="text-2xl font-bold cursor-pointer">bookeStore</a>
                </div>
                ...
                <div className='navbar-end space-x-3'>
                    ...
                    <div className="navbar-end">
                        <a className="px-5 py-2 bg-black text-white font-semibold rounded-lg shadow-md hover:bg-gray-800 transition duration-300 cursor-pointer"
                            onClick={() =>
